...
export async function onLintRuleSlashCommand(
	...
	return reply(InteractionResponseType.ChannelMessageWithSource, {
      ...
      ${ruleData.recommended ? "🌟 Recommended" : ""}${
			ruleData.deprecated ? "⚠️ Deprecated" : ""
		}
...
export async function onLintRuleAutocomplete(
...
export const slashCommandData = new SlashCommandBuilder()
	...
	.addStringOption((option) =>
		option
			.setName("rule")
			.setDescription("The name of the lint rule")
