...
import {
	onLintRuleAutocomplete,
	onLintRuleSlashCommand,
} from "./commands/lint-rule.js";
...
async function handleInteraction(
	...
	return reply(InteractionResponseType.ChannelMessageWithSource, {
		content:
			"Unknown command, you probably shouldn't be able to see this. Please tell us about it!",
		flags: 64,
	});
}
